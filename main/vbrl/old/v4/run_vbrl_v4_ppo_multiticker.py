...
def first_test(tickers, data_path_1day_lst, data_path_1min_lst, restore_path, name="bt_result"):
    ...
    stratagy = VBAgentStratagyV4MT(agent, k=0.6, leverage=2)
...
if __name__ == '__main__':
        ...
        first_test(
            ...
            f"/home/bellmanlabs/Projects/ray_results/VBEnv_V4/PPO/PPO_VBEnv_V4_0_2020-09-08_14-35-28cbmn2el0/checkpoint_{n}/checkpoint-{n}",
