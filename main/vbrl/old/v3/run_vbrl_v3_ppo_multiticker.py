...
def first_test(tickers, data_path_1day_lst, data_path_1min_lst, restore_path, name="bt_result"):
    ...
    for ticker in tickers:
        Ticker = FinancialProduct(ticker, 1e-8, 1e-8, 0.0004, 1, 1, 0.000001)
    ...
    stratagy = VBAgentStratagyV3MT(agent, k=0.6, leverage=2)
...
if __name__ == '__main__':
        ...
        first_test(
            ...
            [
             ...
             #"/home/bellmanlabs/Data/bitmex/trade/ohlc/1H/TRXQUT.csv"
            ],


            f"/home/bellmanlabs/Data/VBEnv_V3/PPO/PPO_VBEnv_V3_0_2020-09-08_10-35-43qsk3pzjh/checkpoint_{n}/checkpoint-{n}",
            name=f"/home/bellmanlabs/Projects/log/vbrl_multiticker/{n}")