...
def first_test(tickers, data_path_1day_lst, data_path_1min_lst, restore_path, name="bt_result"):
    ...
    stratagy = VBAgentStratagyV5MT(agent, k=0.6, leverage=1)
...
if __name__ == '__main__':
        ...
        first_test(
            ...
            f"/home/bellmanlabs/Projects/ray_results/VBEnv_V5/xbt_whole/PPO/PPO_VBEnv_V5_0_2020-09-10_21-30-07ef20me_9/checkpoint_{n}/checkpoint-{n}",
